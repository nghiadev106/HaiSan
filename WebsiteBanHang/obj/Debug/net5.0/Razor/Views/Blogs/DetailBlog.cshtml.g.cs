#pragma checksum "D:\DA\HaiSan\WebsiteBanHang\Views\Blogs\DetailBlog.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d3815da449d25e7b04b10cd8db38611ff10980a4"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d3815da449d25e7b04b10cd8db38611ff10980a4", @"/Views/Blogs/DetailBlog.cshtml")]
    ...
    public class Views_Blogs_DetailBlog : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
    ...
    <div class=""wrapper"">
        <div class=""lf"">
            ...
            WriteLiteral(@"hỏa thuận giữa các bên, bao gồm :</em><br />  <br /> <strong>- Công Ty Cổ Phần COLOR LIFE</strong> - 270F Võ Thị Sáu, P.7, Q.3 là chủ sở hữu website <a href=""http://hoayeuthuong.com/""><strong><em>http://hoayeuthuong.com</em></strong></a><strong>,</strong> sau đây gọi tắt là <strong>haisan</strong>.</p>
...
");
            ...
            WriteLiteral(@"ết định đặt mua. Chúng tôi chỉ nhận lại sản phẩm khi sản phẩm đó không đúng với miêu tả trên trang web của chúng tôi và không đúng với yêu cầu trong đơn đặt mua hàng của khách hàng. Trong trường hợp này, khách hàng sẽ được nhận lại 100% số tiền bao gồm : giá sản phẩm + phí giao hàng. Thời hạn hoàn trả tiền chậm nhất là 5 ngày kể từ ngày nhận được trả lời chính thức của chúng tôi. Khách hàng có thể nhận lại tiền qua chuyển khoản, séc, paypal, hoặc tiền mặt…<br /> Trong tất cả các trường hợp khác, chúng tôi không chịu trách nhiệm đối với các lỗi không phải do chúng tôi gây ra.<br /> Sản phẩm trả lại không đầy đủ, gãy, hỏng, bẩn, rách, mất tag … do lỗi của khách hàng sẽ không được chấp nhận.<br />  <br /> <strong>ĐIỀU KHOẢN 9 – CHĂM SÓC KHÁCH HÀNG</strong><strong> </strong></p>
                ...
                <p>Thời gian phục vụ 24/24. ");
            WriteLiteral(@"Vui lòng xem thêm thông tin tại phần <a href=""http://hoayeuthuong.com/Contact.aspx"">Liên hệ</a>.</p>
                <p> </p>
                ...
                <p><br /> <strong>2/ Thay đổi đơn hàng</strong><br /> Thay đổi sản phẩm trước thời điểm phát hoa dự kiến 04 giờ (hoặc khi sản phẩm chưa được<br /> thiết kế): Được chấp nhận và không tính phí.<br /> Không chấp nhận thay đổi sản phẩm ngay trước thời điểm phát hoặc khi sản phẩm đã được thiết kế.<br /> Trong trường hợp sản phẩm mới có giá trị nhỏ hơn giá trị sản phẩm đã đặt, Công ty không hoàn trả lại tiền chênh lệnh. Trong trường hợp sản phẩm mới có giá trị lớn hơn sản ph");
            WriteLiteral(@"ẩm đã đặt, khách hàng phải thực hiện việc thanh toán giá trị chênh lệch, cộng với phí thay đổi .Việc thực hiện chuyển phát điện hoa sẽ được thực hiện sau khi việc thanh toán hoàn tất.</p>
                <p style=""text-align: right;""><img src=""https://hyt.r.worldssl.net/ShowTopicSubImage.aspx?id=35038""");
            BeginWriteAttribute("alt", " alt=\"", 13616, "\"", 13622, 0);
            EndWriteAttribute();
            ...
            <div class=""b"">
                <a id=""ctl00_cphContent_ucContact_hplAbout"" title=""Giới thiệu"" href=""https://hoayeuthuong.com/gioi-thieu.aspx"">
                    <div class=""contact"">
                        ...
                        <span>Với sự đầu tư nghiêm túc, chúng tôi tập trung nâng cao trải nghiệm người dùng (UX) kể cả trên môi trường trực tuyến và ngoại tuyến để đe");
            WriteLiteral("m lại một dịch vụ hoàn hảo xứng đáng trong nỗ lực trở thành công ty điện hoa số 1 tại Việt Nam.</span>\r\n                    </div>\r\n                </a>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</div>\r\n<div class=\"line-b padding_top_20\">\r\n</div>");
        }
